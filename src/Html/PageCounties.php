...
class PageCounties extends AbstractPage {
    ...
    // Table body with dynamic county rows
    ...
    // Table header, including editor for new county and edit functionality
    static function tableHead()
    {
        ...
        // Editor for adding and editing counties
        self::editor();
    }

    // The editor form for adding and editing counties
    ...
    // Function to update county's name
